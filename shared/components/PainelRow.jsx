...
import Exames from '../container/Exames';
    ...
    render() {
        ...
        return (
            <div title={paciente.atendimento}>
                ...
                <div className={this.rowNormalClass('status')}><Status value={paciente.status} altaMedica={paciente.altaMedica}/></div>
                ...
                <div className={this.rowSmallClass('exame')}><Exames value={paciente.atendimento}/></div>
